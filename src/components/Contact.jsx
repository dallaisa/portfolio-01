...
const Contact = () => {
  return (
    <section id="contact" className="bg-black w-full h-auto flex items-center justify-center">
      <div className="text-center font-[sans-serif] p-8 max-w-2xl">
        <h1 className="text-4xl font-bold text-white">Get in Touch</h1>
        <p className="text-sm text-gray-300 mt-4 leading-relaxed">
          For inquiries or collaboration opportunities, please contact me at 
          <a href="mailto:isabelledallacarlesso@gmail.com" className="text-white underline ml-1">
            Isabelledallacarlesso@gmail.com
          </a>. I’m eager to connect and discuss how we can work together on exciting projects!
        </p>
        ...
        <ul className="flex mt-12 justify-center space-x-4">
          <li className="bg-[#1a082e] hover:bg-[#1a082e] h-10 w-10 rounded-full flex items-center justify-center">
            <a href="https://github.com/dallaisa" target="_blank" rel="noopener noreferrer">
